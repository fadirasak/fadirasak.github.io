...
def _():
    ...
    return db, dt, go, mo, msno, np, pa, pd, pl, plt, px
...
def _(pd, pl):
    ...
    order = pd.read_parquet(
        r"https://raw.githubusercontent.com/fadirasak/fadirasak.github.io/refs/heads/main/apps/public/orders2.parquet",
    )
